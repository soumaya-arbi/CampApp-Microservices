...
import {
  ...
  getDOM,
  setRootDomAdapter
} from "./chunk-Q2A7CFIB.js";
import {
  HTTP_ROOT_INTERCEPTOR_FNS
} from "./chunk-M5CEGETE.js";
import {
  XhrFactory
...
async function* handleRoute(options) {
  try {
    ...
    if (loadChildren2) {
      ...
      const loadedChildRoutes = await loadChildren(route, compiler, parentInjector).toPromise();
...
@angular/platform-server/fesm2022/platform-server.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ORTMOBTR.js.map
